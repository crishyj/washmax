        ...
        <div id="demo" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="{{ asset('assets/img/washMAX1000/1 washMAX 1000.gif') }}">
                
              </div>
              <div class="carousel-item">
                <img src="{{ asset('assets/img/washMAX1000/2 washMAX 1000.gif') }}">
                
              </div>
              <div class="carousel-item">
                <img src="{{ asset('assets/img/washMAX1000/3 washMAX 1000.gif') }}">
    ...
    <div class="row">
      <div class="col-md-12 text-center">
        <div class="detail_header">
          <h2>
            WashMAX 1000 Portable Vehicle Washbay – Low Duty Cycle
          </h2>               
        </div>

        <div class="detail_body mt-2">
          <p>
            Suitable for Low Duty Cycle Applications – up to 1000lt per/hr Water Treatment Capacity 
          </p>
          <p>
          ...
          <div class="mb-2 table-responsive">
            <table class="table table-bordered">
              <thead>
                <tr>
                  <th colspan="6">Accessories & Options</th>
                </tr>
              </thead>
              <tbody>
                <tr>
